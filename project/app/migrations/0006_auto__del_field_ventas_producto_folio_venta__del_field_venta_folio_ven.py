...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ventas_producto.folio_venta'
        db.delete_column(u'app_ventas_producto', 'folio_venta_id')

        # Deleting field 'Venta.folio_venta'
        db.delete_column(u'app_venta', 'folio_venta')

        # Adding M2M table for field producto_venta on 'Venta'
        m2m_table_name = db.shorten_name(u'app_venta_producto_venta')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('venta', models.ForeignKey(orm[u'app.venta'], null=False)),
            ('ventas_producto', models.ForeignKey(orm[u'app.ventas_producto'], null=False))
        ))
        db.create_unique(m2m_table_name, ['venta_id', 'ventas_producto_id'])


    def backwards(self, orm):
        # Adding field 'Ventas_producto.folio_venta'
        db.add_column(u'app_ventas_producto', 'folio_venta',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.Venta']),
                      keep_default=False)

        # Adding field 'Venta.folio_venta'
        db.add_column(u'app_venta', 'folio_venta',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Removing M2M table for field producto_venta on 'Venta'
        db.delete_table(db.shorten_name(u'app_venta_producto_venta'))
    ...
    models = {
        ...
        u'app.venta': {
            ...
            'producto_venta': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['app.Ventas_producto']", 'symmetrical': 'False'}),
