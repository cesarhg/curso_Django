...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Venta.fecha'
        db.alter_column(u'app_venta', 'fecha', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Venta.fecha'
        db.alter_column(u'app_venta', 'fecha', self.gf('django.db.models.fields.DateField')())
